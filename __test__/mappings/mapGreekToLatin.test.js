import mapGreekToLatin from '../../src/mappings/mapGreekToLatin';
...
describe('Checks if the dictionary of greek to latin letters contains the correct data', () => {
  it('Should check if the actual dictionary is the same with the mock dictionary', () => {
    expect(JSON.stringify(mapGreekToLatin)).toBe(JSON.stringify(mockMapGreekToLatin));
  });
});
